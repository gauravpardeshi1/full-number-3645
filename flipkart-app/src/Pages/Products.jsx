...
//     <Heading>Products Page</Heading>
//     <Box border="1px solid blue"  display="flex" justifyContent={"space-between"} gap="10px" padding="10px">
        
//         <Box w="20%" h="auto" border="1px solid red"></Box>

       
//          <Box w="80%" shadow="rgba(50, 50, 93, 0.25) 0px 2px 5px -1px, rgba(0, 0, 0, 0.3) 0px 1px 3px -1px"    h="450px"borderTop="1px solid gray" borderBottom="1px solid gray" display="flex" justifyContent={"space-between"} gap="10px" paddingBottom={"-10px"}>
     
//         <Box w="25%" h="auto" padding="30px"><Image src="https://rukminim1.flixcart.com/image/312/312/kxdl3m80/smartwatch/y/9/i/43-android-ios-wrb-sw-colorfitcaliber-std-blu-blu-noise-no-original-imag9ukqry8xgfq2.jpeg?q=70"/></Box>
//             <Box w="50%" h="auto" >

              
//                 <Heading fontWeight={"600"} padding="15px" textAlign={"start"} as='h4' size='md'>Noise ColorFit Caliber Smart Watch with 15-day battery, 1.69" display, 60 Sports Modes Smartwatch  (Blue Strap, Regular)</Heading>
//                <Box  display="flex" > <Button
//               w="50px"
//               h="25px"
//               marginRight={"5px"}
...
//              </Box>
//             <Box w="25%" h="500px" padding="20px">
//                 <Heading textAlign={"start"} as='h3' size='lg'>₹1,999</Heading>
//                    <Text color="green" textAlign={"start"}>70% off</Text>
//                     <Text textAlign={"start"}>Free Delivery</Text>
